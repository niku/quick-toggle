...
(ert-deftest quick-toggle-apply-matcher:spec-to-lib ()
  (let ((matcher (cons "spec/lib/\\(.+\\)_spec\.rb" "lib/\\1.rb")))
    (my-fixture
     (lambda ()
       (should (equal
                (quick-toggle-apply-matcher matcher "/home/niku/projects/foo/spec/lib/foo_spec.rb")
                "/home/niku/projects/foo/lib/foo.rb"))))))

(ert-deftest quick-toggle-apply-matcher:lib-to-spec ()
  (let ((matcher (cons "lib/\\(.+\\)\.rb" "spec/lib/\\1_spec.rb")))
    (my-fixture
     (lambda ()
       (should (equal
